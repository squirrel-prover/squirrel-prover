...
\begin{definition}
An action $s(\ov{id})$ is a tuple $(\phi,U,o)$, where $\ov{id} \in \I^k$ is a list of indices variable, $\phi$ is a propositional formula, $U$ is a set of states updates (a mapping from state symbols to terms), and $o$ is a list of terms.
