...
\solene{TODO - à poursuivre}

% \begin{example}
%   For example, for the protocol introduced in \Cref{ex:basic-hash-bi-process} and the trace introduced in \Cref{ex:basic-hash-trace}, we would like to verify that the following equivalence holds (amongst many others):
%
