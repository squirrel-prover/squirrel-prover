...
\begin{definition}
  A meta-interpretation $I$\footnote{\adrien{I don't like the name meta-interpretation. Meta-model would be better. Or something like trace-model. }} for $\Sigma = (\F,\M,\N)$ consists in:
  \begin{itemize}
