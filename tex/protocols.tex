...
\begin{definition}
  ...
  \adrien{Calling it abstract trace seems \emph{very} confusing to me. It should be called concrete trace. Then, if it is executable, just say \emph{executable concrete trace}.}
\end{definition}
...
\begin{remark}
  ...
  restrictions of Tamarin). \adrien{Why having an order on actions, and then restrict it further later? Why not do both at the same time?}
\end{remark}
