...
\begin{itemize}
  ...
  \item for each state macro symbol $\sfs$, a meta-logic term $u_{\alpha}^{\sfs}$ (intuitively, the update of $\sfs$ for this action)
