...
\begin{definition}
  ...
  \end{itemize}
  \adrien{I believe there are some inconsistencies later, because we include the valuation of the variables in the trace model. I think it would be clearer, and more standard, to have a trace model without valuation, and to give the semantics as a function of a valuation (which modifies it).}
\end{definition}
