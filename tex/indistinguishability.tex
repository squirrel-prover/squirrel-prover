...
\begin{figure}
  \begin{mathpar}
    ...
    \inferrule[equiv]{
\Gamma \vdash_{\calp_1}  t_1 = t_2 \quad    \Gamma \vdash_{\calp_2}  t_1 = t_2 \quad     \Gamma  \vdash_{\calp_1,\calp_2}  \pvec{u}[ t_1 / t_2] \sim  \pvec{v}[ t_1 / t_2]
    }{
...
\begin{proof}
  ...
  \begin{itemize}
    \item Assume $\xi$ is of the form $\phi_1\wedge\phi_2$ with
      ...
      \david{we invoke the induction hypothesis on $\phi_1$ with
      $\pvec U$ and $\pvec V$, and then use the induction hypothesis
      on $\phi_2$ with the sequence $\pvec U$ (resp. $\pvec V$)
      enriched with
      $\interp{\mframe @ T}{\TM}{\calp_1},
      \myif \interp{\mexec @ T}{\TM}{\calp_1}
      \mythen \interp{\xi}{\TM'}{\calp_1} \myelse \false$
