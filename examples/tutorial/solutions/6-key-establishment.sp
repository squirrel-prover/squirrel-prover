...
Proof.
  (* BEGIN EXO *)
  intro _; induction t; try (auto + expandall; apply IH).
  + (* A *)
    expandall; fa !<_,_>.
    fa (if _ then _), <_,_>.
    cca1 5; [1:auto].
...
Proof.
  (* BEGIN EXO *)
  intro Hap _. 
  rewrite equiv idealize_key_exchange tau; 1: auto.
  (* Now considering right system, where proof is easy
     since sk is only used in Bout. *)
  intro H. 
  fresh H.
  auto.
  (* END EXO *)
